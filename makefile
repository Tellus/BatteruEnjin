...
# Source files.
SOURCES=BE_Surface.cpp BE_Frontend.cpp Action.cpp RandomNumbers.cpp Character.cpp Sizzlorr.cpp Throbulator.cpp main.cpp BE_Primarch.cpp BE_Resource.cpp BE_Ability.cpp
